...
def main(dataset_file):
    ...
    door_frame_frictionloss = uniform(args.frictionloss_low, args.frictionloss_high)
    ...
    name = '{0}_{1}_{2}.xml'
    output_path = os.path.join(args.output_dirname, '{0}_{1}{2}'.format(knob_type, robot_type, args.output_name_extension))
    try:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-name-extension', type=str, default="", help='folder name under world path')
    ...
    parser.add_argument('--frictionloss-low', type=float, default=0.0, help='lower range of frictionloss.')
    parser.add_argument('--frictionloss-high', type=float, default=0.0, help='upper range of frictionloss.')
