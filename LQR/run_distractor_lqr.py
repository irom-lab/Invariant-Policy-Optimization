"""
LQR with distractor observations: simple gradient descent.
"""
...
def main(raw_args=None):
	...
	# K matrix
	K = torch.nn.Parameter(torch.zeros(nu, nx+nyp))
	...
	print(" ")
	print("Costs on test LQR system (GD)")
	print("K exp. cost: ", exp_cost_K)
	print("LQR oracle exp. cost: ", exp_cost_lqr)

	# # Calculate cost-to-go from some random x0 (via rollout), for debugging
	# x0 = torch.randn(nx, 1)
